...
class _InventoryScreenState extends ConsumerState<InventoryScreen> {
                  ...
                  children: [
                    Expanded(
                      child: GestureDetector(
                        onTap: () => _showLowStockModal(context, inventoryState),
                    ...
                    Expanded(
                      child: GestureDetector(
                        onTap: () => _showOutOfStockModal(context, inventoryState),
                        child: _buildAlertCard(
                    ...
                    Expanded(
                      child: GestureDetector(
                        onTap: () => _showAlertsModal(context, inventoryState),
                        child: _buildAlertCard(
  ...
  void _showOutOfStockModal(BuildContext context, InventoryState state) {
    final outOfStockItems = state.items.where((item) => item.currentStock == 0).toList();
    final isMobile = Responsive.isMobile(context);
                  ...
                  child: ListTile(
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Icon(Icons.inventory_2, size: 14, color: iconColor),
                            const SizedBox(width: 4),
                            Text(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Icon(Icons.inventory_2, size: 14, color: alertColor),
                            const SizedBox(width: 4),
                            Text(
                            ...
                            if (alert.threshold != null) ...[
                              const SizedBox(width: 12),
                              Icon(Icons.warning_amber, size: 14, color: AppTheme.neutral600),
                              const SizedBox(width: 4),
                              Text(
