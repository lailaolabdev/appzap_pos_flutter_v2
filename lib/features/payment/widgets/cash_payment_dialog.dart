...
class _CashPaymentDialogState extends ConsumerState<CashPaymentDialog> {
  ...
  void _setQuickAmount(double amount) {
    ...
    print('✅ Updated _tenderedAmount=$_tenderedAmount, canComplete=$_canComplete');
  }
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      onPressed: (_canComplete && !_isProcessing)
                          ? () async {
                              ...
                              try {
                                ...
                                print('🔄 CashPaymentDialog: Processing payment: $finalAmount');
                                ...
                                print('📊 CashPaymentDialog: Payment result = $success');
                                print('   mounted = $mounted');
                                
                                if (success && mounted) {
                                  // ✅ Success! Close dialog and return to main screen
                                  print('✅ CashPaymentDialog: Payment successful, closing dialog...');
                                  Navigator.pop(context, {
                                    'success': true,
                                    'tendered': finalAmount,
                                  ...
                                  print('❌ CashPaymentDialog: Payment failed (success=$success, mounted=$mounted)');
                                  setState(() {
                                    _isProcessing = false;
                                    _errorMessage = 'Payment failed. Please try again.';
                                  });
                                } else {
                                  print('⚠️  CashPaymentDialog: Widget not mounted, cannot update UI');
                                }
                              } catch (e, stackTrace) {
                                // ❌ Exception, show error in dialog
                                print('❌ CashPaymentDialog: Payment exception: $e');
                                ...
                                if (mounted) {
                                  ...
                                  print('⚠️  CashPaymentDialog: Widget not mounted, cannot show error');
                                }
                              }
                            }
                          : null,
